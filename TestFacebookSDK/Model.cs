...
namespace TestFacebookSDK
{
    ...
    {
        #region Messages
        public void SaveMessages(IDictionary<string, object> result)
        {
        ...
        public void SavePhotos(IDictionary<string, object> result)
        {
        ...
        {
            IDictionary<string, object> album = (IDictionary<string, object>)result["album"];
        ...
        public void SavePosts(IDictionary<string, object> result)
        {
        ...
        public void SavePerson(IDictionary<string, object> result)
        {
        ...
        public void SaveLinks(IDictionary<string, object> result)
        {
